...
The latest version is Idris 2 0.5.1. You can find the latest release at:

* `idris2-0.5.1.tgz <https://www.idris-lang.org/idris2-src/idris2-0.5.1.tgz>`_ `(SHA 256 hash) <http://www.idris-lang.org/idris2-src/idris2-0.5.1.tgz.sha256>`__
